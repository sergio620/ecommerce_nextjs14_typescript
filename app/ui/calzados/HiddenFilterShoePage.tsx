...
export default function HiddenFilterShoePage() {
  ...
  return (
    <div
      ...
      }top-0 left-0 fixed md:hidden transition-all h-screen duration-500 z-50 overflow-y-scroll`} //no usar hidden (display: none) mejor usar width 0px o w-0 para luego realizar transiciones de 0px a 100%
    >
      <button
        className="h-11"
        onClick={() => {
